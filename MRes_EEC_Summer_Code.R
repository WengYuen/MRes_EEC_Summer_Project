...
df <- read.csv(file="/Users/User/Desktop/R/temp.csv", header = T)
#Data wrangling
...
field <- read.csv(file = "/Users/User/Desktop/R/field.csv", header = T)
#Data wrangling
...
food <- read.csv(file="/Users/User/Desktop/R/food.csv", header = T)
#Data wrangling
...
com <- read.csv(file = "/Users/User/Desktop/R/comp.csv", header = T)
#Data wrangling
...
pred <- read.csv(file = "/Users/User/Desktop/R/pred.csv", header = T)
#Data wrangling
